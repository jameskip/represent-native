...
const Profile = (props) => {
  ...
  // TODO: GET request to get member's profile using member ID
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.social}>
        ...
        <Text
          onPress={() => {
            Linking.openURL(
              `https://facebook.com/${member.facebook_account}`,
            )
          }}
        >
          facebook{' '}
        ...
        <Text
          onPress={() => {
            Linking.openURL(
              `https://youtube.com/${member.youtube_account}`,
            )
          }}
        >
          youtube{' '}
